...
sed "s/%%/Hello World\!/" <../jar-creation/templates/HelloWorldTemplate >target/generated-sources/HelloWorld/test/HelloWorld.java
...
sed "s/%%/Hallo Welt/" <../jar-creation/templates/HelloWorldTemplate >target/generated-sources/HalloWelt/test/HelloWorld.java
